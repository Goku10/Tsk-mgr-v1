    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl w-full">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-center mt-12">
          <button className="group relative px-12 py-6 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border-2 border-cyan-400/50 rounded-lg text-cyan-300 font-semibold text-xl tracking-wider hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 backdrop-blur-sm min-w-[200px]">
          ...
          <button className="group relative px-12 py-6 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border-2 border-blue-400/50 rounded-lg text-blue-300 font-semibold text-xl tracking-wider hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 backdrop-blur-sm min-w-[200px]">
          ...
          <button className="group relative px-12 py-6 bg-gradient-to-r from-slate-500/20 to-cyan-500/20 border-2 border-slate-400/50 rounded-lg text-slate-300 font-semibold text-xl tracking-wider hover:border-slate-300 hover:shadow-lg hover:shadow-slate-500/50 transition-all duration-300 backdrop-blur-sm min-w-[200px]">
